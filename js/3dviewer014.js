...
//        location.reload(false);
 ...
 //   scene.add(light);
    ...
    function loadfiletotex(ncnt) {
		...
		if(Filenamedisplay) document.getElementById("filename").innerHTML="("+((ncnt/2)+1)+"/"+ (self.file.length/2) + ") " + self.file[ncnt + 1];
		else document.getElementById("filename").innerHTML=""+((ncnt/2)+1)+"/"+ (self.file.length/2);
    ...
    function loadfiletotex2(ncnt) {
            ...
            var file = files[ncnt];
			if(Filenamedisplay) document.getElementById("filename").innerHTML="("+(ncnt+1)+"/"+(files.length)+") " + file.name;
			else document.getElementById("filename").innerHTML=""+(ncnt+1)+"/"+(files.length);
